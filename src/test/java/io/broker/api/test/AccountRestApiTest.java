...
//        System.out.println("\n ------limit buy-----");
//        NewOrderResponse response1 = client.newOrder(NewOrder.limitBuy("ETHUSDT", TimeInForce.GTC, "0.001", "2000.9"));
//        System.out.println(response1);
//
        System.out.println("\n ------limit sell-----");
        NewOrderResponse response2 = client.newOrder(NewOrder.limitSell("ETHUSDT", TimeInForce.GTC, "0.01", "1005"));
        System.out.println(response2);
//
//        System.out.println("\n ------market buy-----");
//        NewOrderResponse response3 = client.newOrder(NewOrder.marketBuy("ETHUSDT", "10"));
//        System.out.println(response3);
//
//        System.out.println("\n ------market sell-----");
//        NewOrderResponse response4 = client.newOrder(NewOrder.marketSell("ETHUSDT", "0.01"));
